...
static PyObject *__pyx_f_14python_wrapper_test_efield_gauss_round(PyObject *__pyx_v_x, PyObject *__pyx_v_y, PyObject *__pyx_v_sigma, PyObject *__pyx_v_Delta_x, PyObject *__pyx_v_Delta_y, CYTHON_UNUSED int __pyx_skip_dispatch) {
  transv_field_gauss_round_data __pyx_v_data;
  double __pyx_v_Ex;
  double __pyx_v_Ey;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "python_wrapper")) {
      if (unlikely(PyDict_SetItemString(modules, "python_wrapper", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
